...
const Dashboard = () => {
  ...
  return (
    <>
      <div>
        <Navbar />
        {loggeduser && loggeduser[0].email == "TechProducts@gmail.com" ? (
          <div className="addprod-container">
            <form onSubmit={handleAddProduct} className="addprod-form">
              ...
              <em className="Disclaimer">
                make a standard Category like Smartphone for mobilephones don't
                use different name for same category like mobile, smartphone,
                Cellphone
              </em>
              <input
